...
png(file = "/Volumes/Hard/Github/Exploratory_Data_Project1/plot4.png", width = 480, height = 480, units = "px")

#Generating plot4
par(mfrow = c(2,2), mar = c(4,4,2,1), oma = c(0,0,2,0)) #Define 4 figures in one place
